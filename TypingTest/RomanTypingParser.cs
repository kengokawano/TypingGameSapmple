...
namespace TypingTest
{
    ...
    {
        private static readonly string _dictionaryJsonFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "romanTypingParseDictionary.json");
        private static readonly Dictionary<string, string[]> _mappingDictionary = new Dictionary<string, string[]>();
        ...
        public static void ReadJsonFile()
        {
            ...
            string jsonStr;
            using (var sr = new StreamReader(_dictionaryJsonFilePath, Encoding.GetEncoding("utf-8")))
            {
                jsonStr = sr.ReadToEnd();
            }

            var jsonData = new JavaScriptSerializer().Deserialize<RomanMapping[]>(jsonStr);
